...
export const metadata: Metadata = {
  ...
  description:
    "Compassionate, professional home care tailored to the unique needs of your loved ones across Maryland — skilled nursing, personal care, companionship, therapies and more.",
};
